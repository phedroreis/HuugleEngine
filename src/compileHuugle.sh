...
echo "* executavel'.                                                              *"
echo "*                                                                           *"
echo "* Crie uma pasta de nome /HuubleEngine dentro da pasta do sistema /opt      *"
echo "* e copie o arquivo HuugleEngine.jar e a pasta /database para dentro        *"
echo "* pasta /HuugleEngine. De exatamente esse nome, respeitando maiusculas      *"
echo "* minusculas.                                                               *"
echo "*                                                                           *"
